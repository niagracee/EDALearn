package com.niyagrace.edalearn.adapter;
...
import com.niyagrace.edalearn.activity.SoalActivity;
...
public class AdapterMateri extends RecyclerView.Adapter<AdapterMateri.MyViewHolder> {
    ...
    List<SemuamateriItem> materi;
    public AdapterMateri(Context context, List<SemuamateriItem> data_listmateri) {
        // Inisialisasi
